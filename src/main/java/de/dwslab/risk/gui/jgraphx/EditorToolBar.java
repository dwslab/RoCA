...
import de.dwslab.risk.gui.jgraphx.EditorActions.FontStyleAction;
...
public class EditorToolBar extends JToolBar {
    ...
    public EditorToolBar(final BasicGraphEditor editor, int orientation) {
        ...
        fonts.addAll(Arrays.asList(new String[] { "Helvetica", "Verdana", "Times New Roman",
        ...
        final JComboBox sizeCombo = new JComboBox(new Object[] { "6pt", "8pt", "9pt", "10pt",
        ...
        final JComboBox zoomCombo = new JComboBox(new Object[] { "400%", "200%", "150%", "100%",
                "75%", "50%", mxResources.get("page"), mxResources.get("width"),
            ...
            // but the change is ignored here
                if (!ignoreZoomChange) {
                    ...
                    if (zoom.equals(mxResources.get("page"))) {
                        ...
                        try {
                            zoom = zoom.replace("%", "");
                            double scale = Math.min(16,
                                    Math.max(0.01, Double.parseDouble(zoom) / 100));
