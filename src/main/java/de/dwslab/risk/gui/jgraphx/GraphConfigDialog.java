        ...
        if ((graphType2 == GraphType.NULL) || (graphType2 == GraphType.SIMPLE_RANDOM_TREE)) {
            ...
            applyButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (graphType2 == GraphType.NULL) {
                        mxGraphGenerator generator = new mxGraphGenerator(null,
                        ...
                        mxGraphGenerator generator = new mxGraphGenerator(mxGraphGenerator
                                .getGeneratorFunction(graph, false, 0, 10),
                                new mxDoubleValCostFunction());
                        Map<String, Object> props = new HashMap<String, Object>();
                        mxGraphProperties.setDirected(props, false);
                        configAnalysisGraph(graph, generator, props);
            ...
            applyButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    graph.removeCells();
                    mxGraphGenerator generator = new mxGraphGenerator(mxGraphGenerator
                            .getGeneratorFunction(graph, weighted, minWeightParam, maxWeightParam),
                            new mxDoubleValCostFunction());
                    Map<String, Object> props = new HashMap<String, Object>();
            ...
            applyButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    int numVertexesInBranchParam = Integer.parseInt(numVertexesInBranchField
                            .getText());
                    Map<String, Object> props = new HashMap<String, Object>();
                    mxGraphProperties.setDirected(props, arrows);
                    mxGraphGenerator generator = new mxGraphGenerator(mxGraphGenerator
                    ...
                    if (graphType2 == GraphType.FRIENDSHIP_WINDMILL) {
                        ...
                        generator.getWindmillGraph(aGraph, numBranchesParam,
                                numVertexesInBranchParam);
                    }

                    generator.setWindmillGraphLayout(aGraph, numBranchesParam,
                            numVertexesInBranchParam, 1000);
                    mxGraphStructure.setDefaultGraphStyle(aGraph, false);
                    setVisible(false);
                }
            });
            ...
            applyButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    generator.setBipartiteGraphSpacing(aGraph, leftNodeCount, rightNodeCount,
                            spacing, spacing * 2);
                    mxGraphStructure.setDefaultGraphStyle(aGraph, false);
                    setVisible(false);
                    graph.getModel().endUpdate();
            ...
            panel.add(forceConnectedBox = new JCheckBox(
                    "Always connected (edge count may be inaccurate)", false));
            JPanel panelBorder = new JPanel();
            panelBorder.setBorder(new EmptyBorder(10, 10, 10, 10));
            panelBorder.add(panel);
            ...
            // setLocationRelativeTo(parent);
                ...
                || (graphType2 == GraphType.INDEGREE) || (graphType2 == GraphType.OUTDEGREE)
                    ...
                    if (startVertex == null) {
                        ...
                        mxTraversal.bfs(aGraph, startVertex, new mxICellVisitor() {
                            ...
                            public boolean visit(Object vertex, Object edge) {
                                ...
                                if (e != null) {
                                    System.out.println("Vertex: " + v.getValue() + " edge: "
                                            + e.getValue());
                                } else {
                        ...
                        System.out.println("Indegree of "
                                + aGraph.getGraph().getModel().getValue(startVertex) + " is "
                                + indegree);
                    } else if (graphType2 == GraphType.OUTDEGREE) {
                        int outdegree = mxGraphStructure.outdegree(aGraph, startVertex);
                        System.out.println("Outdegree of "
                                + aGraph.getGraph().getModel().getValue(startVertex) + " is "
                                + outdegree);
                        ...
                        if (isCutVertex) {
                            System.out.println("Vertex "
                                    + aGraph.getGraph().getModel().getValue(startVertex)
                                    + " is a cut vertex.");
                        } else {
                            System.out.println("Vertex "
                                    + aGraph.getGraph().getModel().getValue(startVertex)
            ...
            applyButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (graphType2 == GraphType.DIJKSTRA) {
                        ...
                        try {
                            mxTraversal.dijkstra(aGraph, startVertex, endVertex,
                                    new mxICellVisitor() {
                    ...
                    if (graphType2 == GraphType.BELLMAN_FORD) {
                        try {
                            List<Map<Object, Object>> bellmanFord = mxTraversal.bellmanFord(aGraph,
                                    startVertex);
                            ...
                            System.out.print("Distances from "
                                    + costFunction.getCost(view.getState(startVertex)) + " to [ ");

                            for (int i = 0; i < vertexNum; i++) {
                                System.out.print(i + ":"
                                        + Math.round((Double) distanceMap.get(vertices[i]) * 100.0)
                                        / 100.0 + " ");
                            }
                            ...
                            for (int i = 0; i < vertexNum; i++) {
                                System.out.print(i
                                        + ":"
                                        + costFunction.getCost(view.getState(parentMap
                                                .get(vertices[i]))) + " ");
                            }
                            ...
                            if ((Double) distanceMap.get(endVertex) != Double.MAX_VALUE) {
                                System.out.println("The shortest distance from vertex "
                                        + costFunction.getCost(view.getState(startVertex))
                                        + " to vertex "
                                        + (Double) costFunction.getCost(view.getState(endVertex))
                                        + " is: " + distanceMap.get(endVertex));
                            } else {
